        ...
        <div class="container-fluid">
            ...
            <div class = "row" style="padding:10px;">
                ...
                <div class="col-md-6">
                    ...
                    <form action="includes/signupisveren.inc.php" method="post" enctype="multipart/form-data" class = "bg-secondary"style="padding:40px; border-radius:25px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label font-weight-bold" style="font-size:22px;">Şirket İsmi: </label>
                            <div class="col-sm-9">
                                <input class="form-control" type="text" name="companyname" placeholder="Şirket ismi">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label font-weight-bold" style="font-size:22px;">Şirket Tanımı: </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label font-weight-bold" style="font-size:22px;">Vergi Numarası: </label>
                            <div class="col-sm-9">
                                <input class="form-control" type="number" name="taxid" placeholder="Vergi numarası">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="row justify-content-md-center">
                            <button type="submit" name = "signup-isveren-submit" class="btn btn-lg btn-success">Kaydol</button>
                        </div>
