    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light" style="background-color: #ffffff;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a href="aradigimeleman/index.php">
                        <button class="btn btn-outline-primary  my-sm-0 text-light bg-primary" style="margin-right:5px;" type="submit">Aradığım Eleman</button>                    
                    </a>
                </li>
                <li class="nav-item">
            ...
            ?>
                ...
                <a href="signup.php">
                    <button class="btn my-sm-0 text-light bg-primary" style="margin-right:5px;">Kaydol</button>                    
                </a>
            <?php } ?>
        </div>
        <div class="col-sm-2"></div>
